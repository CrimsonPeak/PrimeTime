...
public class MainActivity extends YouTubeBaseActivity implements View.OnClickListener {
    ...
    // (4)
    private SharedPreferences prefs; private String year;
    private SharedPreferences prefsSpinner; String spinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // (4) Getting the Year which was chosen in the activity before (and test, with displaying the year in a textView)
        ...
        spinner = prefsSpinner.getString("spin", "");
        year = prefs.getString("year", ""); //0 is the default value

        // (1) Part of updating the textview with one part of an array
        mTestArray = getResources().getStringArray(getResources().getIdentifier(year, "array", getPackageName()));
        updateTextView();
        ...
        */
        ...
        refresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(MainActivity.this, SplashScreen.class));//Start the same Activity
            }
        });
    ...
    // Adds checked Movies to the Database in Disabled DB
    private void addMovieToDBDisabled(){
    ...
    public void disabledMovies(){
        ...
        if(cursor.moveToFirst()){
            finish(); //finish Activity.
            startActivity(new Intent(MainActivity.this, MainActivity.class));//Start the same Activity
        }
    }
    ...
    public void noMoreMovies(){
        ...
        if(count == mTestArray.length){
            Toast toast = Toast.makeText(c, c.getResources().getString(R.string.MainActivity_toast) +" "+ spinner +".\n"+ c.getResources().getString(R.string.MainActivity_toast_), Toast.LENGTH_SHORT);
            ...
            finish(); //finish Activity.
            startActivity(new Intent(MainActivity.this, YearSelectingTest.class));
        }
        else{
            disabledMovies();
        }
    ...
    protected void onStart() {
        ...
        // Initializes the Youtube Player directly on Start
        //Log.d(TAG, "onClick: Initializing YouTube Player.");
        //mYouTubePlayerView.initialize(YoutTubeConfig.getApiKey(), mOnInitializedListener);
    }
