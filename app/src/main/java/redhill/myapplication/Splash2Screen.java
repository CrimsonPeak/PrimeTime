...
public class Splash2Screen extends Activity implements Animation.AnimationListener {
    ...
    public void startMainActivity() {
        Intent mainIntent = new Intent(Splash2Screen.this, Main2Activity.class);
        Splash2Screen.this.startActivity(mainIntent);
        Splash2Screen.this.finish();
    }
